...
class TestDatabase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        ir1 = ImageRecord(
            ...
            file_path="231109-170000-ncl-c.tif",
            imageDepth=2,
            image_id=0,
            ...
            pga_gain=1.0,
            processing_info=10,
            product_id="231109-170000-ncl-c",
            samples=2048,
            software_name="vipersci",
        ...
        ir2 = ImageRecord(
            ...
            file_path="231109-170100-ncl-c.tif",
            imageDepth=2,
            image_id=0,
            immediateDownloadInfo=24,
            instrument_name="NavCam Left",
            ...
            pga_gain=1.0,
            processing_info=10,
            product_id="231109-170100-ncl-c",
            samples=2048,
            software_name="vipersci",
            software_program_name="vipersci.vis.create_image",
            software_version="0.7.0-dev",
        ...
        ir3 = ImageRecord(
            ...
            file_path="231109-170200-ncl-c.tif",
            imageDepth=2,
            image_id=0,
            immediateDownloadInfo=24,
            instrument_name="NavCam Left",
            ...
            pga_gain=1.0,
            processing_info=10,
            product_id="231109-170200-ncl-c",
            samples=2048,
            software_name="vipersci",
            software_program_name="vipersci.vis.create_image",
            software_version="0.7.0-dev",
